...
public class StoreInfoUI {
	...
	public int menu() {
		// 서비스 메뉴 실행시 보여지는 메뉴
		System.out.println("-------------------------------------------------------------------------------------");		// 사용자가 입력한 번호에 해당하는 가게 정보를 담아준것을 사용 
		...
		System.out.println("실시간 좌석수 : " + StoreSearchStatus.store.getStoNowSeat() + "/" + StoreSearchStatus.store.getStoSeat());		
		System.out.println("-------------------------------------------------------------------------------------");
