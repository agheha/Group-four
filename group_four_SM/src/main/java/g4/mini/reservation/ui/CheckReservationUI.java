...
public class CheckReservationUI extends BaseUI {

	private ReservationMapper mapper;

	Store storedata =  StoreSearchStatus.store; //상세보기에 저장해둔 스토어변수 출력
	Store storeLogin = StoreLoginStatus.login; //로그인한 가게
	User userL = LoginStatus.login; //로그인한 유저
	
	public CheckReservationUI() {
