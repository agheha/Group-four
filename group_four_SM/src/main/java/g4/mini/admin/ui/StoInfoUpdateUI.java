...
public class StoInfoUpdateUI extends BaseUI {
	...
	public void service() {
		...
		System.out.println("-------------------------------------------------------------------------------------");
		int stoNo = getInt("정보를 수정할 회원번호를 선택하세요 : ");
		
		Store sto = mapper.selectOneStore(stoNo);
		System.out.println("-------------------------------------------------------------------------------------");
		...
		System.out.println("-------------------------------------------------------------------------------------");
		int choice =  getInt("☞ 수정할 항목의 번호를 입력해주세요 : ");
